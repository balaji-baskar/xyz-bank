...
import com.ab.bank.exception.CustomerNotFoundException;
...
public class CustomerController {
	...
	public ModelAndView doFundTransfer(@RequestParam int id, @RequestParam int amount) throws Exception {
		ModelAndView modelAndView;
		...
		receiver = customerService.findById(id);
			...
			throw new CustomerNotFoundException("No customer is found with this customer ID");
		}
